...
export function TodoList({
  ...
  return (
    ...
    >
      ...
      {todos.length === 0 ? (
        <p className="rounded-xl border border-dashed border-zinc-300 px-3 py-6 text-center text-sm text-zinc-500 dark:border-zinc-600 dark:text-zinc-400">
          No tasks yet. Add one to pair with your Focus sessions.
        </p>
      ) : (
